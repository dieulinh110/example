...
re_store_sales <- reactive({
  ...
  validate(
   ...
   out[,15:ncol(out)] <- sapply((out[, 15:ncol(out)]), as.double)
   total <- sapply(out[, 15:ncol(out)], function(x) sum(x, na.rm = T))
